...
export declare function isPlatform(platform: unknown): platform is PlatformType;
export declare function isEvent(event: unknown): event is RPCEvent;
export declare function isCommand(command: unknown): command is RPCCommand;
export declare function isMessage(message: unknown): message is RPCPayload;
